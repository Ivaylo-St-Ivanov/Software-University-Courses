class SmartHike {
    ...
    showRecord(criteria) {
        ...
        const filtered = this.listOfHikes.filter(x => x.difficultyLevel == criteria);
        ...
        if (criteria != 'all') {
            ...
            this.listOfHikes.forEach(el => output.push(`${this.username} hiked ${el.peak} for ${el.time} hours`));
            return output.join('\n');
        }
    }
}
